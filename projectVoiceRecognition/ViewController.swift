...
//    let language = "en-US";
    ...
    @IBAction func showMessage(sender: UIButton) {
        let alertController = UIAlertController(title: "Welcome to our First App", message: "Hello ! This is Kenan and Fayçal !", preferredStyle: UIAlertController.Style.alert)
